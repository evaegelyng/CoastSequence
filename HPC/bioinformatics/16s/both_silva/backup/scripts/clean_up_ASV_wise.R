...
setwd("/HPC/bioinformatics/16s/both_silva/results/cleanup_ASV_wise/spring")
...
setwd("/HPC/bioinformatics/16s/both_silva/tmp")
...
setwd("/HPC/bioinformatics/16s/both_silva/results/cleanup_ASV_wise/autumn")
...
setwd("/HPC/bioinformatics/16s/both_silva/results/cleanup_ASV_wise/summary")
