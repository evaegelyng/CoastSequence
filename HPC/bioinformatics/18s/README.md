...
3. scripts/import_merge_EES.R
4. scripts/clean_up_ASV_wise.R
5. scripts/no_sing_ASV_wise.R
6. scripts/Count_reads.r
7. ncbi_nt_tax/scripts/add_count_fa.r
8. ncbi_nt_tax/workflow.py (calling the scripts odin_240903.r taxonomy_v0_1_1_EES.R)
9. scripts/loki.r
