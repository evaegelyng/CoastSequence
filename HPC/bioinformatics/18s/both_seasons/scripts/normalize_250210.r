...
# Load OTU table
otu_tab<-read.table("/HPC/bioinformatics/18s/both_seasons/ncbi_nt_tax/results/COSQ_Curated_LULU_97.tsv", sep="\t", header=T, row.names=1,check.names=F)
...
write.table(tax_otu_top_max, "ncbi_nt_tax/results/HPC/bioinformatics/18s_classified_all.tsv", sep="\t", quote=FALSE, row.names=FALSE)
...
write.table(phy_class_uniq, "ncbi_nt_tax/results/HPC/bioinformatics/18s_classified_phy_class.tsv", sep="\t", quote=FALSE, row.names=FALSE)
## Import manually curated table
tax_env<-read.table("ncbi_nt_tax/results/HPC/bioinformatics/18s_classified_phy_class_curated.txt",sep="\t", header=T)
