...
vsearch_file=/HPC/bioinformatics/COI/tmp/COSQ_vsearch.fasta # fasta file before swarm
tmp_dir=/HPC/bioinformatics/COI/tmp/ # directory where OTU table is stored
input_dir=/HPC/bioinformatics/COI/results/ # directory where the output of swarm is stored (see line 46)
scripts_dir=/HPC/bioinformatics/COI/scripts/  # directory where store required scripts (see line 163)
DnoisE_dir=/home/USERNAME/miniconda3/pkgs/dnoise-1.0-py38_0/lib/python3.8/site-packages/src/ 
...
motus_dir=/HPC/bioinformatics/COI/tmp/motus/
motus_tab_dir=/HPC/bioinformatics/COI/tmp/motu_tab/
output_dir=/HPC/bioinformatics/COI/tmp/output_Ad_corr/
final_dir=/HPC/bioinformatics/COI/tmp/finalfiles/
