...
mjolnir4_ODIN_coastseq <- 
function(lib,cores,d=13,min_reads_MOTU=2,min_reads_ESV=2,run_swarm=TRUE,generate_ESV=FALSE,obipath=""){

  dnoise_path <- "/home/USERNAME/miniconda3/pkgs/dnoise-1.0-py38_0/lib/python3.8/site-packages/src/DnoisE.py"    # Change this to where the Dnoise executable is
...
mjolnir4_ODIN_coastseq(lib,cores,d=13,run_swarm=TRUE,generate_ESV=FALSE)
