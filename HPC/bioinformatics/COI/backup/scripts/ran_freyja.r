...
lib <- as.character(args[2]) # Same as lib_prefixes as each library is run separately in the gwf workflow
...
mjolnir1_RAN(R1_filenames,cores,lib_prefixes=lib_prefix,R1_motif="_1.",R2_motif="_2.") # Removed "R" in motifs
