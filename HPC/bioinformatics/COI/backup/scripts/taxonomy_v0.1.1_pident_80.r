...
assign_taxonomy <- function(table,lower_margin=2, remove = c("")) {       # removed constant upper margin specification
...
prefilter <- function(IDtable, lower_margin=2, remove = c("uncultured", "environmental")) {   # removed constant upper_margin specification
...
my_classified_result <- assign_taxonomy(IDtable, lower_margin = 2, remove = c("uncultured", "environmental")) # removed constant upper_margin specification
