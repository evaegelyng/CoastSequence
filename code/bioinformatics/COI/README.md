...
Overview of folders/files and their contents: There are two gwf workflow files (workflow_part1.py and workflow.py) and a folder with scripts containing scripts that are either called from the workflow files or run separately. 
