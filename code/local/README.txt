...
Overview of folders/files and their contents: The folder contains the scripts for all three barcodes, which were run on a laptop.
...
*Within the folder COI_97/ASV_level, the scripts should be run in the following order:
